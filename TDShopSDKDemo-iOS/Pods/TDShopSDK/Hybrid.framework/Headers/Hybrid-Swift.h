...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Hybrid",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC6Hybrid15HybridWKWebView")
@interface HybridWKWebView : UIView
...
SWIFT_CLASS("_TtC6Hybrid19HybridWKWebViewCore")
@interface HybridWKWebViewCore : WKWebView <NSURLSessionTaskDelegate, WKNavigationDelegate, WKUIDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC6Hybrid13HybridWebView")
@interface HybridWebView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC6Hybrid17HybridWebViewCore")
@interface HybridWebViewCore : UIWebView <NSURLSessionTaskDelegate, UIWebViewDelegate, SonicSessionDelegate>
...
SWIFT_CLASS("_TtC6Hybrid12TDHybridCore")
@interface TDHybridCore : NSObject
