#
#  Be sure to run `pod spec lint TDShopSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "kcheng" => "541123382@qq.com" }
  ...
  spec.source       = { :git => "https://github.com/YangKunCheng/TDShopSDK.git", :tag => "#{spec.version}" }
